...
<body>
    ...
    <section class="home " id="home">
        <img src="{{ asset('assets/img/1.jpg') }}" class="home-img" alt="" />
        <div class="home-content">
            ...
            @if (Route::has('login'))
                @auth
                    <a href="{{ url('/home') }}" class="btn btn-danger btn-block">Go to Dashboard</a>
                @else
                    <a href="{{ route('login') }}" class="btn btn-danger btn-block">Get Started</a>
                @endauth
            @endif
        </div>
    </section>
