@if ($paginator->hasPages())
    <ul class="pagination">
        ...
        @if ($paginator->onFirstPage())
            <li class="page-item disabled"><a class="page-link"><span>Prevoius</span></a></li>
        @else
            <li class="page-item"><a href="{{ $paginator->previousPageUrl() }}" class="page-link"
                    rel="prev">Prevoius</a></li>
        @endif
        ...
        @if ($paginator->hasMorePages())
            <li class="page-item"><a href="{{ $paginator->nextPageUrl() }}" class="page-link"><span>Next</span></a>
            </li>
        @else
