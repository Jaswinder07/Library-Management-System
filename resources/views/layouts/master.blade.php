...
<head>
    ...
    <!-- Main Admin-Lte Style.css -->
    <link href="{{ asset('assets/css/admin-lte-style.css') }}" rel="stylesheet">
...
<body>
    ...
    <div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header">
        ...
        <div class="app-header header-shadow">
            <div class="app-header__logo">
                <div class="logo-src">
                    <strong>
                        <h5 class="text-success"> <b> Dashboard </b> </h5>
                    </strong>                    
                </div>
                            ...
                            <div class="widget-content-wrapper">
                                <div class="widget-content-left">
                                    <div class="btn-group">
                                        ...
                                        @if (is_null(Auth::user()->dob) || is_null(Auth::user()->contact) || is_null(Auth::user()->designation) || is_null(Auth::user()->address) || is_null(Auth::user()->gender))
                                        ...
                                        <div tabindex="-1" role="menu" aria-hidden="true"
                                            ...
                                            <a href="/user-profile-view" tabindex="0" class=" dropdown-item"> View </a>
                                            <a href="/edit-Profile" tabindex="0" class=" dropdown-item">Change
                                                Profile</a>
                                            <a href="/change-password" tabindex="0" class=" dropdown-item">Change
                                                Password </a>
                    ...
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="/add-staff-members">
                                            <i class="metismenu-icon">
                                            </i>Registration
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/staff-members-list">
                                            <i class="metismenu-icon">
                                            </i>Staff Member List
                                        </a>
                                    </li>
                            ...
                            <li>
                                <a href="/issue-book">
                                    <i class="metismenu-icon fas fa-circle-notch">
                                    </i>Issue Books
                                </a>
                            </li>
                            <li>
                                <a href="/issue-book-list">
                                    <i class="metismenu-icon fas fa-share"></i>
                                    Issue List
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <i class="metismenu-icon fab fa-shopware"></i>
                                    Reports
                                    <i class="metismenu-state-icon fas fa-angle-down caret-left"></i>
                                </a>
                                <ul>
                                    <li>
                                        <a href="/add-lost-damage-books">
                                            <i class="metismenu-icon">
                                            </i>Add Lost/Damage Books
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/lost-damage-book-list">
                                            <i class="metismenu-icon">
                                            </i>See List
                                        </a>
                                    </li>
                        ...
                        <div class="app-footer__inner">
                                ...
                                <ul class="nav">
                                    <li class="nav-item">
                                        <a href="javascript:void(0);" class="nav-link ">
                                            <strong>Copyright &copy; 2021</strong>&nbsp; | Yo ! Libe
                                        </a>
                                    </li>
                                </ul>
                            </div>
                            <div class="app-footer-right">
                                <ul class="nav">
                                    ...
                                    <li class="nav-item">
                                        <a href="https://www.facebook.com/profile.php?id=100010367022914"
                                            class="nav-link">
                                            developed@jaswinder &nbsp; <i class="fab fa-facebook-square"></i>
                                        </a>
                                    </li>
                                    </li>
                                </ul>
    ...
    <!-- Main Admin-Lte Main.Js  -->
    <script type="text/javascript" src="{{ asset('assets/js/admin-lte-main.js') }}"></script>
